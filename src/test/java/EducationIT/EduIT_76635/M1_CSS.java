...
public class M1_CSS 
{
	...
	//variables
		...
		WebElement txtBusqueda=navegador.findElement(By.cssSelector("input[type='text'][id='search_query_top'][name='search_query']"));   // xpath por atributo
		// WebElement txtBusqueda=navegador.findElement(By.xpath("//input[contains(@id,\"search_query_top\")]"));   // xpath por id 
			
		//ubicar boton 
		//WebElement btnBusqueda=navegador.findElement(By.cssSelector("button[type='submit'][class='btn btn-default button-search']"));
		WebElement btnBusqueda=navegador.findElement(By.cssSelector("button.btn.btn-default.button-search"));
